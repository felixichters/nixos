...
Variables like min, max, rd, gen, dis cannot be replaced with auto because their types (T, random_device, mt19937, uniform_real_distribution) are explicitly needed and known.
